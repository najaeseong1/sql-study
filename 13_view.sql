...
SELECT * FROM view_emp WHERE salary >= 6000;
...
INSERT INTO view_emp_dept_jobs
(e.employee_id, d.department_name, j.job_title, e.salary)
VALUES(300,'test','test','test',10000);
...
-- 뷰를 생성할 때 사용한 조건 컬럼은 뷰를 통해서만 변경할 수 없게 해주는 키워드
...
-- 읽기 전용 뷰 -> WITH READ ONLY (DML 연산을 다 막음 -> SELECT만 허용)
