...
--UPDATE dept2 SET loca = 4000 WHERE dept_no = 10; -- 실패(외래키 제약조건 위반)
...
CREATE TABLE members(
    ...
    m_num NUMBER(5) CONSTRAINT mem_memmnum_pk PRIMARY KEY, 
...
SELECT 
    m_name,m_num,TO_CHAR(reg_date,'YYYY-MM-DD') AS reg_date,
    gender,loca
FROM members;
